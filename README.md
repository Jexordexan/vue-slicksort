...
| `appendHelperToContainer`    | Boolean                                                 | `false`                                                                                       | If you want the helper element to be appended to the slicksort container instead of the document body, set this to true                                                                                                                                                                                                                                                                                                  |
