...
| `pressDelay`                 | Number                                                  | `0`                                                                                           | If you'd like elements to only become sortable after being pressed for a certain time for all devices, change this property. Cannot be used in conjunction with the `distance` prop.                                                                                                                                                                                                                                      |
| `touchDelay`                 | Number                                                  | `200`                                                                                         | If you'd like elements to only become sortable after being pressed for a certain time for touch devices, change this property. A good sensible default value for mobile is `200`. Cannot be used in conjunction with the `distance` and `pressDelay` props.                                                                                                                                                               |
| `clickDelay`                 | Number                                                  | `0`                                                                                           | If you'd like elements to only become sortable after being pressed for a certain time for non-touch devices, change this property. Cannot be used in conjunction with the `distance` and `pressDelay` props.                                                                                                                                                                                                              |
